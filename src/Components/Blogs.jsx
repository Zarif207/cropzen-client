      ...
      <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center gap-16">
        ...
        >
          ...
          <p className="text-[#D69E2E] text-lg mb-6 font-medium">
            We have 30 years of agriculture & eco farming experience globally,
            work with professionals{" "}
          </p>
          <p className="text-gray-600 mb-10 leading-relaxed">
            There are many variations of passages of lorem ipsum available but
            the majority have suffered alteration in some form by injected humor
            or random word that donor send minimum take minute some lorem ipsum
            text which don't look even.
          </p>
